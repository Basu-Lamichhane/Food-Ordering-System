...
<x-alert/>
 <div class="card">
    <div class="card-header">
        <h3 class="card-title" style="font-size:1.5em;font-weight: bold">Orders for {{$location}}</h3>
            ...
            <tbody>
                ...
                <tr style="color:white; background-color:rgb(184, 184, 184);">
                    ...
                    <td>
                        ...
                        <a class="px-2" href="{{url('delivery/orders/'.$order->id)}}"><i class="fa fa-eye"></i> Manage</a>
